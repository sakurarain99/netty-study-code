...
class Client(Iface):
    ...
    def savePersion(self, person):
        ...
        """
        self.send_savePersion(person)
        self.recv_savePersion()

    def send_savePersion(self, person):
...
class Processor(Iface, TProcessor):
    ...
    def process_savePersion(self, seqid, iprot, oprot):
        ...
        result = savePersion_result()
        try:
            self._handler.savePersion(args.person)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except DataException as dataException:
...
class savePersion_args(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(savePersion_args)
savePersion_args.thrift_spec = (
    None,  # 0
...
class savePersion_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(savePersion_result)
savePersion_result.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'dataException', [DataException, None], None, ),  # 1
)
